...
window.RTCMultiConnection = function(roomid, forceOptions) {
    ...
    function SocketConnection(connection, connectCallback) {
        ...
        connection.socket.on('onunmute', function(remoteUserId, data) { 

            if (!connection.peers[remoteUserId]) return;
            $("#" + data + " audio").prop('muted', false);
        });
    
        connection.socket.on('onmute', function(remoteUserId, data) { 
            if (!connection.peers[remoteUserId]) return;
            $("#" + data + " audio").prop('muted', true);
        });
