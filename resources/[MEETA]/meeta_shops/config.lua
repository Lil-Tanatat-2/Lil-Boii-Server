...
Config.Zones = {
	...
	TwentyFourSeven = {
		...
		Pos = {
			...
			{x = 312.94,  y = -588.48, z = 43.0},
			{x = 913.93,  y = -961.46, z = 44.65},
			{x = 1801.13,  y = 2486.67, z = -124.59}
		},
		ShowBlip = true,
		Category =  "Normal",
		Marker = true
	...
	CarWash = {
		Items = {},
		Pos = {
			{x = -40.17,   y = -1094.12, z = 26.42},
			{x = 1737.64,  y = 3710.7, z = 34.14},
			{x = 1039.5,  y = 2664.83, z = 39.55},
			{x = 1656.05,  y = 4874.03, z = 42.04},
			{x = -93.33,  y = 6410.75, z = 31.64}
		},
		CustomBlip = {
			Text = "Car Wash Shop",
			Blip = 326,
