...
Config.EnableWeapons              = false    -- If true spawn Guards with Weapons (can change in ped.lua)
--Biker DLC--
...
Config.Locations1 = { -- Some Shop & Interior NPCs
	...
	{ x = 2433.86,    y = 4969.04, z = 41.35, heading = 216.50 },    -- Grove Str Cannabis Dealer
	...
	{ x = -603.14,  y = 232.37,   z = 118.17, heading = 170.83 }, 
	{ x = 281.18,  y = -477.27, z = 33.27, heading = 272.17 }, 
	{ x = 753.22,  y = -3193.02, z = 5.07, heading = 246.58 }, 
	{ x = 752.81,  y = -3197.65, z = 5.07, heading = 246.09 }, 
