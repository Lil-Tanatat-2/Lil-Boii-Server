                        ...
                        if(vehicle ~= "locked")then
                            ...
                            if(time > timer)then
                                ...
                                TriggerEvent("pNotify:SendNotification", {
                                    text = 'กรุณารอ <strong class="red-text">'.. (timer / 1000) ..'</strong> วินาที',
                                    type = "success",
                                    timeout = 3000,
                                    layout = "bottomCenter",
                                    queue = "global"
                            ...
                            TriggerEvent("pNotify:SendNotification", {
                                text = '<strong class="red-text">ไม่พบกุญแจ</strong>',
                                type = "success",
                                timeout = 3000,
                                layout = "bottomCenter",
                                queue = "global"
...
AddEventHandler("ls:getHasOwner", function(hasOwner, localVehId, localVehPlate, localVehLockStatus)
    if(not hasOwner)then
        ...
        TriggerEvent("pNotify:SendNotification", {
            text = '<strong class="green-text">'..getRandomMsg()..'</strong>',
            type = "success",
            timeout = 3000,
            layout = "bottomCenter",
            queue = "global"
        ...
        TriggerEvent("pNotify:SendNotification", {
            text = '<strong class="red-text">ไม่ใช่รถของคุณ</strong>',
            type = "success",
            timeout = 3000,
            layout = "bottomCenter",
            queue = "global"
