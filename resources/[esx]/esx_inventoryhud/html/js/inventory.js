...
window.addEventListener("message", function (event) {
    ...
    if (event.data.action == "display") {
        ...
        if (type === "normal") { //เปิดช่องเก็บของ
            ...
            $("#col-other").show();
            $('#playerInventory').css('width', '510px');
            $('#otherInventory').css('width', '510px');
    ...
    $.each(items, function (index, item) {
        ...
        var html_items = '<div id="item-' + index + '" class="col slot-1 action faster" style="padding: 0px;display: none;" data-index="'+ index +'" data-type="inventory" data-item-type="'+ itemtype +'">' + 
                                    '<div class="card slot z-depth-0">' +
                                        ...
                                        '<div class="card-content" align="center" style="padding: 10px 0 10px 0;">' + count + '</div>' + 
                                        '<div class="card-content content-action-inventory" align="center" style="padding: 0px 0 10px 0;">' + 
                                            '<button type="button" data-index="'+ index +'" class="btn-floating btn-large btn-flat waves-effect waves-green" style="margin-right: 10px;opacity: 0.9" data-action="use"><i class="material-icons">' + using_icon + '</i></button>' + 
                                            '<a data-index="'+ index +'" class="btn-floating btn-large btn-flat waves-effect waves-light" style="margin-right: 10px;opacity: 0.9" data-action="give"><i class="material-icons">card_giftcard</i></a>' +
                                            '<a data-index="'+ index +'" class="btn-floating btn-large btn-flat waves-effect waves-light" style="margin-right: 10px;opacity: 0.9" data-action="drop"><i class="material-icons">delete</i></a>' +  
                                        '</div>' + 
