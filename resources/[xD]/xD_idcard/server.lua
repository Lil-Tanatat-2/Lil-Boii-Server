...
-- Open ID card
RegisterServerEvent('cdc5be83-c880-48c9-93a8-c57db0c8f87e')
AddEventHandler('cdc5be83-c880-48c9-93a8-c57db0c8f87e', function(ID, targetID, type)
		...
		if (user[1] ~= nil) then
			...
			function (licenses)
				...
				if show then
					...
					TriggerClientEvent('94ffa0a9-19e2-4cc5-8377-f6b3be73deee', _source, array, type)
				else
